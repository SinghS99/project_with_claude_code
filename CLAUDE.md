...
## GitHub
- My GitHub username is: SinghS99
- Remote repo naming: same as local folder name
- Default branch: main
...
- Remote: https://github.com/SinghS99/project_with_claude_code.git
- Always commit to a feature branch, never directly to main
- Use bash commands, not PowerShell/pwsh