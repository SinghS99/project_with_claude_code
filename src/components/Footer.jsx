        ...
        <div className="relative border-t border-gray-700/50 mt-16 pt-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex flex-wrap justify-center md:justify-start gap-6 text-sm text-gray-400 mb-6 md:mb-0">
              <a
                title="Read how JobPortal collects, uses, and protects your personal information."
              ...
              <a
                title="Review the terms and conditions that govern your use of JobPortal's services."
                className="group relative hover:text-white transition-colors duration-300 cursor-pointer"
              >
              ...
              <a
                title="Learn how JobPortal uses cookies to improve your browsing experience and personalize content."
                className="group relative hover:text-white transition-colors duration-300 cursor-pointer"
              >
